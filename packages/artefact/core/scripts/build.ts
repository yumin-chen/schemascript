...
console.info("Building core schemas and migrations...");
...
console.info("Building core application...");
...
console.info(`Built core with version ${version.trim()}, commit ${gitCommit.trim()}, build time ${buildTime}.`);
